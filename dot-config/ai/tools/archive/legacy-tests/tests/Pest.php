...
function getLogger(): LinkValidator\Utils\Logger
{
    return new LinkValidator\Utils\Logger();
}

function getSecurityValidator(): LinkValidator\Utils\SecurityValidator
{
    return new LinkValidator\Utils\SecurityValidator();
}

function getCLIArgumentParser(): LinkValidator\Core\CLIArgumentParser
{
    return new LinkValidator\Core\CLIArgumentParser(getLogger());
}

function getLinkValidator(): LinkValidator\Core\LinkValidator
{
    return new LinkValidator\Core\LinkValidator(getLogger(), getSecurityValidator());
}

function getReportGenerator(): LinkValidator\Core\ReportGenerator
{
    return new LinkValidator\Core\ReportGenerator(getLogger());
}
