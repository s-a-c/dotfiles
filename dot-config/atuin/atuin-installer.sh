...
APP_NAME="atuin"
APP_VERSION="18.3.0"
ARTIFACT_DOWNLOAD_URL="${INSTALLER_DOWNLOAD_URL:-https://github.com/atuinsh/atuin/releases/download/v18.3.0}"
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"install_prefix":"AXO_INSTALL_PREFIX","provider":{"source":"cargo-dist","version":"0.15.0"},"source":{"app_name":"atuin","name":"atuin","owner":"atuinsh","release_type":"github"},"version":"18.3.0"}
EORECEIPT
# Are we happy with this same path on Linux and Mac?
RECEIPT_HOME="${HOME}/.config/atuin"
...
The installer for atuin 18.3.0
...
>>>>>>> origin/develop
        "aarch64-apple-darwin")
            ...
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-aarch64-apple-darwin-update"
            _updater_bin="atuin-aarch64-apple-darwin-update"
            ;;
        "aarch64-unknown-linux-gnu")
            _artifact_name="atuin-aarch64-unknown-linux-gnu.tar.gz"
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-aarch64-unknown-linux-gnu-update"
            _updater_bin="atuin-aarch64-unknown-linux-gnu-update"
            ;;
        "aarch64-unknown-linux-musl-dynamic")
            _artifact_name="atuin-aarch64-unknown-linux-musl.tar.gz"
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-aarch64-unknown-linux-musl-update"
            _updater_bin="atuin-aarch64-unknown-linux-musl-update"
            ;;
        "aarch64-unknown-linux-musl-static")
            ...
            ;;
        "x86_64-apple-darwin")
            _artifact_name="atuin-x86_64-apple-darwin.tar.gz"
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-x86_64-apple-darwin-update"
            _updater_bin="atuin-x86_64-apple-darwin-update"
            ;;
        "x86_64-unknown-linux-gnu")
            _artifact_name="atuin-x86_64-unknown-linux-gnu.tar.gz"
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-x86_64-unknown-linux-gnu-update"
            _updater_bin="atuin-x86_64-unknown-linux-gnu-update"
            ;;
        "x86_64-unknown-linux-musl-dynamic")
            _artifact_name="atuin-x86_64-unknown-linux-musl.tar.gz"
            _zip_ext=".tar.gz"
            _bins="atuin"
            _bins_js_array='"atuin"'
            _updater_name="atuin-x86_64-unknown-linux-musl-update"
            _updater_bin="atuin-x86_64-unknown-linux-musl-update"
            ;;
...
install() {
    ...
    if [ -z "${_install_dir:-}" ]; then
        # Install to $HOME/.atuin/bin
        if [ -n "${HOME:-}" ]; then
            _install_dir="$HOME/.atuin/bin"
            _receipt_install_dir="$_install_dir"
            _env_script_path="$HOME/.atuin/bin/env"
            _install_dir_expr='$HOME/.atuin/bin'
            _env_script_path_expr='$HOME/.atuin/bin/env'
        fi
    fi
