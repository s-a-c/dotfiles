...
- Hover preview:
  ![Hover](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-wiki-hover.png)
- Completion:
  
  - Wiki link to another document:
    ![Completion for wiki](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-wiki-compl.png)

  - Wiki link to a subsection of the current document:
    ![Completion for wiki heading](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-wiki-heading-compl.png)

  - Reference link:
    ![Completion for ref link](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-ref-compl.png)
- "Show References":
  ![Show references](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-find-references.png)
- Project-wide diagnostics for broken wiki-links:
  ![Diagnostics](https://github.com/artempyanykh/marksman-vscode/raw/HEAD/assets/readme/vsc-diag.png)
