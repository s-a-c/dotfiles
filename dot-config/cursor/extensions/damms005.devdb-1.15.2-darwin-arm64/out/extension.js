...
async function activate(context) {
    ...
    const provider = vscode.window.registerWebviewViewProvider(devdb_view_provider_1.DevDbViewProvider.viewType, devDbViewProvider, {
        webviewOptions: {
    ...
    context.subscriptions.push(devDbViewProvider.onDidChangeVisibility(visible => {
