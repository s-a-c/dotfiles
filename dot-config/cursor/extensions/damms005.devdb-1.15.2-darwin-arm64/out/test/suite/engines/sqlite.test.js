...
describe('Sqlite Tests', () => {
    it('sqlite: should return correct foreign key definitions', async () => {
        let sequelize = new sequelize_1.Sequelize({ dialect: 'sqlite', logging: false });
    ...
    `);
        const sqlite = new sqlite_engine_1.SqliteEngine();
    ...
    describe('SqliteEngine Tests', () => {
        let sqlite;
        beforeEach(async () => {
            sqlite = new sqlite_engine_1.SqliteEngine();
