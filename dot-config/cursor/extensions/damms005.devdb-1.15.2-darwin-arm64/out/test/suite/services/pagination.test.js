...
describe('Pagination Tests', () => {
    it('should handle the first page correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 1, 100, 10);
    ...
    it('should handle a middle page correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 5, 100, 10);
    ...
    it('should handle the last page correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 10, 100, 10);
    ...
    it('should handle zero total items correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 1, 0, 10);
        assert.strictEqual(result.prevPage, undefined);
        assert.strictEqual(result.nextPage, undefined);
    ...
    it('should handle a single item correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 1, 1, 10);
        assert.strictEqual(result.prevPage, undefined);
        assert.strictEqual(result.nextPage, undefined);
        assert.strictEqual(result.endPage, 1);
    ...
    it('should handle a single page with less items than per page limit', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 1, 8, 10);
        assert.strictEqual(result.prevPage, undefined);
        assert.strictEqual(result.nextPage, undefined);
        assert.strictEqual(result.endPage, 1);
    ...
    it('should handle the second page when total items are exactly one page plus one', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 2, 11, 10);
    ...
    it('should handle a large number of total items correctly', () => {
        const result = (0, pagination_1.getPaginationFor)('test', 50, 1000000, 20);
