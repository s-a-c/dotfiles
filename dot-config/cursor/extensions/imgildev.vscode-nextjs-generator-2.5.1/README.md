...
See the following documentation about [how to create files](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/docs/generate-files.md) for more information.

### Terminal Commands

See the following documentation about [how to use the terminal commands](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/docs/cli-commands.md) for more information.

### Snippets

See the following documentation about [how to use the snippets](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/docs/snippets.md) for more information.

### Context Menu

See the following documentation about [how to use the context menu](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/docs/context-menu.md) for more information.
...
Before contributing, please read our [Contribution Guidelines](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/CONTRIBUTING.md) for instructions on coding standards, testing, and more.

## Code of Conduct

We are committed to providing a friendly, safe, and welcoming environment for all, regardless of gender, sexual orientation, disability, ethnicity, religion, or similar personal characteristic. Please review our [Code of Conduct](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/CODE_OF_CONDUCT.md) before participating in our community.

## Changelog

For a complete list of changes, see the [CHANGELOG.md](https://github.com/ManuelGil/vscode-nextjs-generator/blob/HEAD/CHANGELOG.md)
