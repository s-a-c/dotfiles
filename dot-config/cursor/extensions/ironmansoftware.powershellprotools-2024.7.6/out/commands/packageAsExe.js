...
exports.packageAsExe = void 0;
const vscode = require("vscode");
const path = require("path");
const fs = require("fs");
const container_1 = require("../container");
const settings_1 = require("../settings");
function makeDefaultPackageConfig(rootPath) {
...
function packageAsExe() {
    return vscode.commands.registerCommand('powershell.packageAsExe', (resource) => {
        ...
        container_1.Container.PowerShellService.Package(packageManifest);
    });
}
exports.packageAsExe = packageAsExe;
//# sourceMappingURL=packageAsExe.js.map