...
class WelcomePanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(WelcomePanel.viewType, 'PowerShell Pro Tools - Welcome', column || vscode.ViewColumn.One, getWebviewOptions(extensionUri));
...
WelcomePanel.viewType = 'psohtoolsWelcome';
