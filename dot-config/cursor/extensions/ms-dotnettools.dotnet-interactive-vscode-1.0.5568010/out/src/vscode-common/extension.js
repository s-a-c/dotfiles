...
const surveyBanner_1 = require("./surveyBanner");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function configureKernel(compositeKernel, notebookUri) {
            ...
            compositeKernel.registerCommandHandler({
                ...
                handle: (commandInvocation) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let value;
                    let customInputRequest = yield vscodeNotebookManagement.handleCustomInputRequest(prompt, requestInput.type, password);
                    if (customInputRequest.handled) {
                        ...
                        switch (requestInput.type) {
                            case "file":
                                value = yield vscode.window.showOpenDialog({
                                    canSelectFiles: true,
                                ...
                                break;
                            default:
                                value = yield vscode.window.showInputBox({ prompt, password, ignoreFocusOut: true });
                                break;
                        }
                    }
                    if (!value) {
            ...
            compositeKernel.registerCommandHandler({
                ...
                handle: (commandInvocation) => __awaiter(this, void 0, void 0, function* () {
                    const sendEditableCode = commandInvocation.commandEnvelope.command;
        ...
        surveryBanner = new surveyBanner_1.SurveyBanner(context.globalState, []);
        disposables.push(() => surveryBanner === null || surveryBanner === void 0 ? void 0 : surveryBanner.dispose());
    });
}
