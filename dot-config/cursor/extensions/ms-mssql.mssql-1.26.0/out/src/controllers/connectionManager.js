...
class ConnectionInfo {
    get loginFailed() {
        return (this.errorNumber !== undefined &&
            ...
            if (Utils.isNotEmpty(result.connectionId)) {
                ...
                if (connection.credentials.connectionString) {
                    connection.credentials =
                        yield this.populateCredentialsFromConnectionString(connection.credentials, result.connectionSummary);
                }
    ...
    onChooseLanguageFlavor() {
        return __awaiter(this, arguments, void 0, function* (isSqlCmdMode = false, isSqlCmd = false) {
            ...
            if (fileUri && this._vscodeWrapper.isEditingSqlFile) {
                if (isSqlCmdMode) {
                    serviceclient_1.default.instance.sendNotification(LanguageServiceContracts.LanguageFlavorChangedNotification
                        .type, {
                        uri: fileUri,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield vscode.window.withProgress({
                ...
                if (connectionCreds.authenticationType === Constants.azureMfa) {
                    if (azureController_1.AzureController.isTokenInValid(connectionCreds.azureAccountToken, connectionCreds.expiresOn)) {
                        ...
                        if (account) {
                            ...
                            let azureAccountToken = yield this.azureController.refreshAccessToken(account, this.accountStore, profile.tenantId, providerSettings_1.default.resources
                                .databaseResource);
                            if (!azureAccountToken) {
                                ...
                                if (refreshResult ===
                                    ...
                                    yield this.azureController.populateAccountProperties(profile, this.accountStore, providerSettings_1.default.resources
                                        .databaseResource);
                                }
                                else {
                                    throw new Error(LocalizedConstants.cannotConnect);
                ...
                let connectionPromise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    if (((_a = connectionCreds.connectionString) === null || _a === void 0 ? void 0 : _a.includes(connectionStore_1.ConnectionStore.CRED_PREFIX)) &&
                        ((_b = connectionCreds.connectionString) === null || _b === void 0 ? void 0 : _b.includes("isConnectionString:true"))) {
