...
class QueryRunner {
    ...
    runStatement(line, column) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.doRunQuery({
                startLine: line,
                startColumn: column,
                endLine: 0,
                endColumn: 0,
            }, (onSuccess, onError) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this._client
                    .sendRequest(queryExecute_1.QueryExecuteStatementRequest.type, queryDetails)
                    .then(onSuccess, onError);
            }));
        });
    }
    // Pulls the query text from the current document/selection and initiates the query
    runQuery(selection, executionPlanOptions, promise) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.doRunQuery(selection, (onSuccess, onError) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield this._client
                    .sendRequest(queryExecute_1.QueryExecuteRequest.type, queryDetails)
                    .then(onSuccess, onError);
            }));
        });
    }
    ...
    handleQueryComplete(result) {
        ...
        (0, telemetry_1.sendActionEvent)(telemetry_2.TelemetryViews.QueryEditor, telemetry_2.TelemetryActions.QueryExecutionCompleted, undefined, {
    ...
    copyHeaders(batchId, resultId, selection) {
        return __awaiter(this, void 0, void 0, function* () {
            let copyString = "";
            let firstCol;
            let lastCol;
