...
exports.WebviewPanelController = void 0;
...
function readFile(filePath) {
    return (0, util_1.promisify)(fs_1.readFile)(filePath);
}
...
class WebviewPanelController {
    constructor(_vscodeWrapper, uri, title, serverProxy, baseUri, statusView) {
        ...
        const config = this._vscodeWrapper.getConfiguration(Constants.extensionConfigSectionName, this._vscodeWrapper.parseUri(this.uri));
        ...
        this.proxy = (0, protocol_1.createProxy)(createMessageProtocol(this._panel.webview), serverProxy, false);
