...
class ConnectionCredentials {
                    ...
                    default: (value) => __awaiter(this, void 0, void 0, function* () {
                        if (value.connectionString) {
                            if (value.savePassword) {
                                ...
                                let connectionString = yield connectionStore.lookupPassword(value, true);
    ...
    static isPasswordBasedCredential(credentials) {
        ...
        return (authenticationType ===
            utils.authTypeToString(interfaces_1.AuthenticationTypes.SqlLogin));
    }
