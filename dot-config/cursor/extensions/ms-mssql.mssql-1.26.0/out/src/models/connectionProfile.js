...
class ConnectionProfile extends connectionCredentials_1.ConnectionCredentials {
            ...
            questions.push({
                ...
                onAnswered: (value) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (value !== "addAccount") {
                        ...
                        try {
                            profile =
                                yield azureController.populateAccountProperties(profile, accountStore, providerSettings_1.default.resources.databaseResource);
                            if (profile) {
    ...
    isValidProfile() {
        ...
        if (this.authenticationType) {
            if (this.authenticationType ===
                interfaces_1.AuthenticationTypes[interfaces_1.AuthenticationTypes.Integrated] ||
                this.authenticationType ===
                    interfaces_1.AuthenticationTypes[interfaces_1.AuthenticationTypes.AzureMFA]) {
