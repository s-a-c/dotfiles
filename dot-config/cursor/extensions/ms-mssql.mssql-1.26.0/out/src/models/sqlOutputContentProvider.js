...
class SqlOutputContentProvider {
    ...
    get shouldUseOldResultPane() {
        return (!this.isRichExperiencesEnabled ||
        ...
        if (this._queryResultsMap.has(uri)) {
            ...
            queryRunner.eventEmitter.on("start", (panelUri) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.shouldUseOldResultPane) {
                    ...
                    if (!this._queryResultWebviewController.hasPanel(uri)) {
                        yield vscode.commands.executeCommand("queryResult.focus");
                    }
            ...
            queryRunner.eventEmitter.on("message", (message) => {
                if (this.shouldUseOldResultPane) {
                    ...
                    if (this._lastSendMessageTime <
                        Date.now() - MESSAGE_INTERVAL_IN_MS) {
                        this._queryResultWebviewController.getQueryResultState(uri).tabStates.resultPaneTab =
            ...
            queryRunner.eventEmitter.on("complete", (totalMilliseconds, hasError, isRefresh) => {
                ...
                if (this.shouldUseOldResultPane) {
                    ...
                    const tabState = Object.keys(this._queryResultWebviewController.getQueryResultState(uri).resultSetSummaries).length > 0
    ...
    newResultPaneViewColumn(queryUri) {
        ...
        switch (splitPaneSelection) {
            ...
            default:
                if (this._vscodeWrapper.activeTextEditor.viewColumn ===
