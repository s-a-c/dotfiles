...
class ObjectExplorerService {
        ...
        const handler = (result) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.success) {
                ...
                if (self._currentNode &&
                    ...
                    nodeLabel = !nodeLabel
                        ? (0, connectionInfo_1.getConnectionDisplayName)(self._currentNode.connectionInfo)
                        : nodeLabel;
                    ...
                    nodeLabel = !nodeLabel
                        ? (0, connectionInfo_1.getConnectionDisplayName)(nodeConnection)
                        : nodeLabel;
                ...
                if (errorNumber ===
                    ...
                    if (handleFirewallResult.result &&
                        ...
                        void self._connectionManager.connectionUI.handleFirewallError(nodeUri, profile, handleFirewallResult.ipAddress);
                    }
                }
                else if (self._currentNode.connectionInfo.authenticationType ===
                    Constants.azureMfa &&
    ...
    getSavedConnections() {
        ...
        for (const conn of savedConnections) {
            let nodeLabel = conn.label === conn.connectionCreds.server
                ? (0, connectionInfo_1.getConnectionDisplayName)(conn.connectionCreds)
                : conn.label;
            this._nodePathToNodeLabelMap.set(conn.connectionCreds.server, nodeLabel);
            let node = new treeNodeInfo_1.TreeNodeInfo(nodeLabel, {
                type: Constants.disconnectedServerLabel,
                filterable: false,
                hasFilters: false,
                subType: "",
            }, vscode_1.TreeItemCollapsibleState.Collapsed, undefined, undefined, Constants.disconnectedServerLabel, undefined, conn.connectionCreds, undefined, undefined);
            this._rootTreeNodeArray.push(node);
        }
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (connectionCredentials) {
                ...
                if (connectionCredentials.connectionString) {
                    ...
                    if (connectionCredentials_1.ConnectionCredentials.isPasswordBasedCredential(connectionCredentials)) {
                        ...
                        if (Utils.isEmpty(password)) {
                            ...
                            if (!connectionCredentials
                                ...
                                password =
                                    yield this._connectionManager.connectionStore.lookupPassword(connectionCredentials);
                                if (connectionCredentials.authenticationType !==
                                    Constants.azureMfa) {
                    ...
                    else if (connectionCredentials.authenticationType ===
                ...
                if (connectionCredentials.profileName) {
                    ...
                    connectionCredentials.server, connectionCredentials.profileName);
                }
    ...
    removeObjectExplorerNode(node_1) {
        return __awaiter(this, arguments, void 0, function* (node, isDisconnect = false) {
            ...
            if (!isDisconnect) {
                ...
                let disconnectedNode = new treeNodeInfo_1.TreeNodeInfo(label, {
                    type: Constants.disconnectedServerLabel,
                    filterable: false,
                    hasFilters: false,
                    subType: "",
                }, node.collapsibleState, node.nodePath, node.nodeStatus, Constants.disconnectedServerLabel, undefined, node.connectionInfo, node.parentNode, undefined);
            ...
            (0, telemetry_1.sendActionEvent)(telemetry_2.TelemetryViews.ObjectExplorer, isDisconnect
                ? telemetry_2.TelemetryActions.RemoveConnection
                : telemetry_2.TelemetryActions.Disconnect, {
    ...
    addDisconnectedNode(connectionCredentials) {
        const label = connectionCredentials.profileName
            ...
            : (0, connectionInfo_1.getConnectionDisplayName)(connectionCredentials);
        const node = new treeNodeInfo_1.TreeNodeInfo(label, {
            type: Constants.disconnectedServerLabel,
            filterable: false,
            hasFilters: false,
            subType: "",
        }, vscode.TreeItemCollapsibleState.Collapsed, undefined, undefined, Constants.disconnectedServerLabel, undefined, connectionCredentials, undefined, undefined);
        this.updateNode(node);
    }
    /**
