...
class QueryHistoryProvider {
    constructor(_connectionManager, _outputContentProvider, _vscodeWrapper, _untitledSqlDocumentService, _statusView, _prompter) {
        ...
        this._queryHistoryUI = new queryHistoryUI_1.QueryHistoryUI(this._prompter);
    }
    clearAll() {
        this._queryHistoryNodes = [new queryHistoryNode_1.EmptyHistoryNode()];
     ...
     */
    openQueryHistoryEntry(node_1) {
        return __awaiter(this, arguments, void 0, function* (node, isExecute = false) {
            ...
            if (isExecute) {
                ...
                yield this._outputContentProvider.runQuery(this._statusView, uri, undefined, title, {}, // empty execution plan options
                queryPromise);
                yield queryPromise;
