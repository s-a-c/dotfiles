...
exports.collapseAll = exports.expandAll = exports.filterIcon = exports.sortReverseAlphabetically = exports.sortAlphabetically = exports.sortByImportance = exports.disableTooltip = exports.enableTooltip = exports.highlightOps = exports.properties = exports.search = exports.customZoom = exports.zoomToFit = exports.zoomOut = exports.zoomIn = exports.openQuery = exports.openPlanFile = exports.save = void 0;
exports.getIconPaths = getIconPaths;
exports.getBadgePaths = getBadgePaths;
exports.getCollapseExpandPaths = getCollapseExpandPaths;
...
function getCollapseExpandPaths(colorTheme) {
    const theme = (0, utils_1.themeType)(colorTheme);
    return {
        expand: theme === "light"
...
const disableTooltip = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const disableTooltipIcon = theme === "dark"
...
const sortByImportance = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const sortByImportanceIcon = theme === "dark"
...
const sortAlphabetically = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const sortAlphabeticallyIcon = theme === "dark"
...
const sortReverseAlphabetically = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const sortReverseAlphabeticallyIcon = theme === "dark"
...
exports.sortReverseAlphabetically = sortReverseAlphabetically;
const filterIcon = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const filterIcon = theme === "dark"
        ? require("./icons/filterDark.svg")
        : require("./icons/filter.svg");
    return filterIcon;
};
exports.filterIcon = filterIcon;
const expandAll = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const expandAllIcon = theme === "dark"
        ? require("./icons/expandAllDark.svg")
        : require("./icons/expandAll.svg");
    return expandAllIcon;
};
exports.expandAll = expandAll;
const collapseAll = (colorTheme) => {
    const theme = (0, utils_1.themeType)(colorTheme);
    const collapseAllIcon = theme === "dark"
...
//# sourceMappingURL=queryPlanSetup.js.map
