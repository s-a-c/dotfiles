...
let AppComponent = AppComponent_1 = class AppComponent {
    ...
    constructor(dataService, shortcuts, _el) {
        ...
        this.shortcutfunc = {
            ...
            'event.selectAll': () => {
                ...
                grid.selection = [
                    new angular2_slickgrid_1.SlickGrid.Range(0, 1, grid._grid.getDataLength() - 1, grid._grid.getColumns().length - 1)
                ];
            },
            'event.saveAsCSV': () => {
            ...
            'event.changeColumnWidth': () => __awaiter(this, void 0, void 0, function* () {
                var _a;
                ...
                if (activeGrid) {
                    ...
                    if (!((_a = columns[activeCell.cell]) === null || _a === void 0 ? void 0 : _a.resizable)) {
                        return;
                    }
                    const newWidth = yield this.dataService.getNewColumnWidth(columns[activeCell.cell].width);
                    if (newWidth) {
        ...
        this.dataIcons = [
            {
                ...
                functionality: (batchId, resultId, index) => {
                    this.magnify(index);
                    this.dataService.sendActionEvent(telemetry_1.TelemetryViews.ResultsGrid, telemetry_1.TelemetryActions.ResultPaneAction, {
            ...
            switch (event.type) {
                ...
                case 'resultSet':
                    ...
                    dataSet.columnDefinitions.unshift({
                        ...
                        field: 'rowNumber',
                        width: 22,
                        type: interfaces_1.FieldType.Integer,
                        focusable: true,
                        selectable: false,
    ...
    openContextMenu(event, batchId, resultId, index) {
        ...
        if (contextMenuCell || grid.canCellBeActive(contextMenuCell.row, contextMenuCell.cell)) {
            if (selection.length === 0 || !this.isContextMenuCellWIthinSelection(selection, contextMenuCell)) {
                selection = [new angular2_slickgrid_1.SlickGrid.Range(contextMenuCell.row, contextMenuCell.cell - 1, contextMenuCell.row, contextMenuCell.cell - 1)];
    ...
    isContextMenuCellWIthinSelection(selections, contextMenuCell) {
    ...
    tryCombineSelectionsForResults(selections) {
...
__decorate([
    (0, core_1.ViewChild)('resultsheader'),
    __metadata("design:type", core_1.ElementRef)
], AppComponent.prototype, "resultsGroupHeaderButton", void 0);
__decorate([
    (0, core_1.ViewChild)('messagesheader'),
    __metadata("design:type", core_1.ElementRef)
], AppComponent.prototype, "messagesGroupHeaderButton", void 0);
__decorate([
    (0, core_1.ViewChild)('contextmenu'),
    __metadata("design:type", contextmenu_component_1.ContextMenu)
], AppComponent.prototype, "contextMenu", void 0);
__decorate([
    (0, core_1.ViewChild)('messagescontextmenu'),
...
__decorate([
    (0, core_1.ViewChildren)('slickgrid'),
    __metadata("design:type", core_1.QueryList)
], AppComponent.prototype, "slickgrids", void 0);
exports.AppComponent = AppComponent = AppComponent_1 = __decorate([
    (0, core_1.Component)({
        selector: 'my-app',
        host: {
    ...
    __param(0, (0, core_1.Inject)((0, core_1.forwardRef)(() => data_service_1.DataService))),
    __param(1, (0, core_1.Inject)((0, core_1.forwardRef)(() => shortcuts_service_1.ShortcutService))),
    __param(2, (0, core_1.Inject)((0, core_1.forwardRef)(() => core_1.ElementRef))),
