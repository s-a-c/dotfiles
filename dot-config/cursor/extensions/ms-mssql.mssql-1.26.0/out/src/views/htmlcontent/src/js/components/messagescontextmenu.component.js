...
exports.MessagesContextMenu = void 0;
...
exports.MessagesContextMenu = MessagesContextMenu = __decorate([
    (0, core_1.Component)({
        selector: 'msg-context-menu',
        providers: [shortcuts_service_1.ShortcutService],
        template: template
    }),
    __param(0, (0, core_1.Inject)((0, core_1.forwardRef)(() => shortcuts_service_1.ShortcutService))),
