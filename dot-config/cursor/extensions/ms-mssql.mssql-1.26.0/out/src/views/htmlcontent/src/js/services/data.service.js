...
let DataService = class DataService {
    constructor() {
        ...
        this._proxy = (0, protocol_1.createProxy)(createMessageProtocol(), {
    ...
    sendActionEvent(telemetryView, telemetryAction, additionalProps, additionalMeasurements) {
    ...
    getNewColumnWidth(currentWidth) {
