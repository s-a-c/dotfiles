...
class DebugRuntime extends events_1.EventEmitter {
    ...
    async initializeRequest(response, args, request) {
        ...
        const rStartupArguments = await (0, utils_1.getRStartupArguments)(this.launchConfig);
        rStartupArguments.cwd || (rStartupArguments.cwd = (_a = vscode.workspace.workspaceFolders) === null || _a === void 0 ? void 0 : _a[0].uri.fsPath);
        ...
        this.rSession = new rSession_1.RSession(tmpHandleLine, tmpHandleDapData, tmpEchoStdin);
        ...
        // cat message from R
        const escapedStartupString = (0, utils_1.escapeStringForR)(this.rStrings.startup + '\n');
        ...
        const escapedLibraryNotFoundString = (0, utils_1.escapeStringForR)(this.rStrings.libraryNotFound + '\n');
        ...
        if (this.rPackageFound && this.rPackageVersionCheck.versionOk) {
            ...
            (0, installRPackage_2.explainRPackage)(tmpWriteOutput, longMessage);
    ...
    async abortInitializeRequest(response, message) {
        ...
        await (0, utils_1.timeout)(this.terminateTimeout);
    ...
    handleLine(line, from, isFullLine) {
        ...
        if (isStdout) {
            if (!this.rPackageFound && isFullLine) {
                ...
                if (RegExp((0, utils_1.escapeForRegex)(this.rStrings.startup)).test(line)) {
                ...
                if (RegExp((0, utils_1.escapeForRegex)(this.rStrings.libraryNotFound)).test(line)) {
                ...
                // check for prompt
                const promptRegex = new RegExp((0, utils_1.escapeForRegex)(this.rStrings.prompt));
                ...
                const continueRegex = new RegExp((0, utils_1.escapeForRegex)(this.rStrings.continue));
    ...
    async handlePrompt(which, text) {
        ...
        const timeout = (0, utils_1.config)().get('timeouts.prompt', 0);
        if (timeout > 0) {
    ...
    handleJson(json) {
        ...
        if (json.type === 'response') {
            if (json.command === 'initialize') {
                ...
                const versionCheck = (0, installRPackage_1.checkPackageVersion)(this.rPackageInfo.Version);
    ...
    dispatchRequest(request, usePort = true) {
        ...
        if (!this.rSession) {
            ...
            const escapedDap = (0, utils_1.escapeStringForR)(dapString);
            const cmdDap = `${this.rStrings.packageName}:::.vsc.handleDap(${escapedDap})`;
            (_a = this.rSession) === null || _a === void 0 ? void 0 : _a.writeToStdin(cmdDap);
        }
    }
    //////////////////////////////////////////////
    // OUTPUT
    writeOutput(text, addNewline = false, category = 'stdout', line = 1) {
