...
Fixes issue [#48](https://github.com/yousefvand/shellman/issues/48)

## 5.6.1

- Fixed [#47](https://github.com/yousefvand/shellman/issues/47) (thanks to Haltarys)
...
- Fixed [#34](https://github.com/yousefvand/shellman/issues/34) (Argument parsing for switches may result in infinite loop).
- Numerous bug fixed in `fn`s.

## 5.5.0

- `process Name by ID`: Get process name by it's ID(s).
- Fixed [#28](https://github.com/yousefvand/shellman/issues/28) (COMMANDS.md links not working).
- Added animation examples for pendular mode.
- Fixed [#29](https://github.com/yousefvand/shellman/issues/29) (thanks to @rwin-novo).
- Fixed [#30](https://github.com/yousefvand/shellman/issues/30) and [#32](https://github.com/yousefvand/shellman/issues/32) (thanks to @jsbrain).
...
- Added samples:
  - Step by step [sample script](https://github.com/yousefvand/shellman/blob/HEAD/samples/backup-tool) tutorial.
...
- Animation
  ...
  - Call `animate` function. Check [sample animations](https://github.com/yousefvand/shellman/blob/HEAD/samples/animation/funny-cat.sh).
  - pacman animation for texts. Check [sample animations](https://github.com/yousefvand/shellman/blob/HEAD/samples/animation/pacman.sh).
- String
