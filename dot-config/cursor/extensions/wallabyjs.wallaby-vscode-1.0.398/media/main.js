$(window).on('load', function () {
  ...
  $('.feature').each(function () {
    ...
    if ($(this).attr('data-start-date')) {
      const startDate = new Date($(this).attr('data-start-date'));
    ...
    if ($(this).attr('data-end-date')) {
      const endDate = new Date($(this).attr('data-end-date'));
      if (endDate < new Date()) {
        $(this).remove();
      }
    }
    ...
    switch (licenseDetails.state) {
      ...
      case 'expired':
        ...
        $('.feature').each(function () {
          ...
          const [featureMajor, featureMinor, featureRevision] = $(this)
            .attr('data-core-version')
            .split('.')
  ...
  window.addEventListener('message', (message) => {
    ...
    switch (event.command) {
      case 'initialState':
        ...
        $('.open-sample').click(function (e) {
          e.preventDefault();
          vscode.postMessage({ command: 'openSampleProject' });
        });
        ...
        function activateLicense() {
          ...
          setTimeout(function () {
            if (
              licenseDetails &&
              ((licenseDetails.email && licenseDetails.onlineLicense) || (licenseDetails && licenseDetails.key))
            ) {
