...
pub const Module = struct {
    ...
    fn writeParamToStream(self: Module, stream: anytype, param: anytype, inst_table: *const InstPtrTable) !void {
    ...
    fn writeInstParamToStream(self: Module, stream: anytype, inst: *Inst, inst_table: *const InstPtrTable) !void {
