...
(defun opam-detect-installed-tools ()
  (let* ((command "opam list --installed --short --safe --color=never")
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 26cad118c4edce89fcd39ca302db4e09 ## you can edit, but keep this line
