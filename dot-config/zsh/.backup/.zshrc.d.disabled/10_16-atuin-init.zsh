...
# This file provides atuin integration for improved history search and management
# Dependencies: atuin command, zsh-autosuggestions plugin (optional)
# Load Order: 15 - Tool environments (after basic tools, before git config)
...
if ! command -v atuin >/dev/null 2>&1; then
    zf::debug "# [atuin-init] atuin not found, skipping initialization"
    return 0
fi
...
zf::debug "# [atuin-init] Atuin initialization complete"
