...
# NOTE: Shell options (setopt/unsetopt) are now managed centrally in:
# 00-centralized-shell-options.zsh (loads before this module)
# This ensures consistent option management and plugin compatibility
_env_debug "Shell options centralized - skipping local setopt commands"
