...
if command_exists go || [[ -d "$HOME/go" ]]; then
    ...
    zf::debug "# [dev-tools] Go environment configured"
fi
...
if command_exists node || command_exists npm; then
    ...
    zf::debug "# [dev-tools] Node.js environment configured"
fi
...
if command_exists python3 || command_exists pip3; then
    ...
    zf::debug "# [dev-tools] Python environment configured"
fi
...
if command_exists rustc || [[ -d "$HOME/.cargo" ]]; then
    ...
    zf::debug "# [dev-tools] Rust environment configured"
fi
...
if command_exists deno || [[ -d "$HOME/.deno" ]]; then
    ...
    zf::debug "# [dev-tools] Deno environment configured"
fi
...
if command_exists php || command_exists composer; then
    ...
    zf::debug "# [dev-tools] PHP/Composer environment configured"
fi

zf::debug "# [10-tools] Development tools configured"
