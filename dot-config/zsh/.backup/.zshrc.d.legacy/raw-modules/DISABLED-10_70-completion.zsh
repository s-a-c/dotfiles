...
zf::debug "# Loading completion system integration"

# Check if centralized completion management is available
if [[ -n "${ZSH_COMPLETION_MANAGEMENT_LOADED:-}" ]]; then
    zf::debug "# Using centralized completion management system"
    ...
    zf::debug "# Fallback: Using simple completion system"
...
zf::debug "# Completion system integration loaded"
