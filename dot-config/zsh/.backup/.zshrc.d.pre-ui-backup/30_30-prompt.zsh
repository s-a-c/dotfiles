...
[[ "$ZSH_DEBUG" == "1" ]] && {
        zf::debug "# ++++++ $0 ++++++++++++++++++++++++++++++++++++"
    zf::debug "# [prompt-ui] Setting up prompt and UI configurations"
}

## [ui.bullet-train] - Bullet Train theme configuration
{
    zf::debug "# [ui.bullet-train]"
...
if command_exists starship; then
    ...
    zf::debug "# [prompt] Starship prompt initialized"
    return 0
fi
...
setup_builtin_prompt() {
    ...
    zf::debug "# [prompt] Built-in prompt configured"
}
...
if command_exists starship; then
    ...
    if zgenom_available; then
        ...
        zf::debug "# [prompt] Powerlevel10k prompt loaded"
    fi
else
    # Use built-in prompt
    setup_builtin_prompt
...
zf::debug "# [prompt-ui] ✅ Prompt and UI configurations applied"
