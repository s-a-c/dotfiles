#!/usr/bin/env zsh
# Emergency Autopair Fix Script
# Run this in your shell: source fix-autopair-emergency.zsh

echo "🚨 Emergency Autopair Fix Script"
echo "=================================="
...
echo "  source $ZDOTDIR/fix-autopair-emergency.zsh  - Re-run this script"

echo
echo "✅ Emergency autopair fix completed!"