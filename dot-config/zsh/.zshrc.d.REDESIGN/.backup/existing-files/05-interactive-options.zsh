...
# --------------------------------------------------
# Initialize RPS Prompt Variables (prevent parameter not set errors)
#   Oh My Zsh and other plugins may reference these unconditionally.
#   Initialize as empty strings if unset to prevent crashes.
# --------------------------------------------------
: ${RPS1:=""}
: ${RPS2:=""}
: ${RPS3:=""}
