...
[[ "$ZSH_DEBUG" == "1" ]] && {
        zsh_debug_echo "# ++++++ $0 ++++++++++++++++++++++++++++++++++++"
    zsh_debug_echo "# [plugin-environments] Setting up plugin-specific environments"
}
...
## [plugins.you-should-use] - Alias usage reminder
{
    ...
    export YSU_MESSAGE_FORMAT="$(command -v tput >/dev/null 2>&1 && tput setaf 1 || zsh_debug_echo '')Hey! I found this %alias_type for %command: %alias$(command -v tput >/dev/null 2>&1 && tput sgr0 || zsh_debug_echo '')"
