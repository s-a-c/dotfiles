...
#          integrated source/execute detection and context-aware 040-testing
...
export ZSH_HELPERS_TESTING="1"  # Disable auto-initialization for 040-testing
...
# 1.5. Load helper library for 040-testing
...
main() {
        ...
        zf::debug "========================================================"
        zf::debug "Timestamp: $(utc_timestamp)"
    ...
    echo
        zf::debug "=== Test Statistics ==="
        zf::debug "Total Tests: $TESTS_RUN"
        zf::debug "Passed: $TESTS_PASSED"
        zf::debug "Failed: $TESTS_FAILED"

    if (( TESTS_FAILED == 0 )); then
            zf::debug "✅ All tests passed!"
        return 0
    else
