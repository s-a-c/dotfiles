...
This directory contains comprehensive documentation for the sophisticated ZSH configuration located at `/Users/s-a-c/.config/zsh/`. The configuration is based on [zsh-quickstart-kit](https://github.com/unixorn/zsh-quickstart-kit) with extensive customizations for performance, security, and developer productivity.
...
- **AI Guidelines**: [`/Users/s-a-c/.config/ai/guidelines.md`](/Users/s-a-c/.config/ai/guidelines.md)
...
**Navigation:** [Top ↑](#zsh-configuration-documentation) | [Master Index →](010-zsh-configuration/000-index.md)
