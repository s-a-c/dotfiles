...
config_files=(
    "${HOME}/.config/zsh/.zshrc.pre-plugins.d.00/080-early-node-runtimes.zsh"
    "${HOME}/.config/zsh/.zshrc.d/500-shell-history.zsh"
    "${HOME}/.config/zsh/.zshrc.d/510-npm-config-validator.zsh"
    "${HOME}/.config/zsh/.zshrc.d.00/400-aliases.zsh"
    "${HOME}/.config/zsh/.zshrc.d.00/530-nvm-post-augmentation.zsh"
    "${HOME}/.config/zsh/.zshrc.add-plugins.d.00/220-dev-node.zsh"
)
