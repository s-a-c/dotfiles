...
Compliant with /Users/s-a-c/.config/ai/guidelines.md vb7f03a299a01b1b6d7c8be5a74646f0b5127cbc5b5d614c8b4c20fc99bc21620
...
- Published artifacts (preferred root):
  - .config/zsh/docs/redesignv2/artifacts/badges/goal-state.json
  - .config/zsh/docs/redesignv2/artifacts/badges/summary-goal.json
...
```sh
.config/zsh/tools/generate-goal-state-badge.zsh \
  --output .config/zsh/docs/redesignv2/artifacts/badges/goal-state.json
```

Generate summary-goal (reads goal-state and optional suffix sources):
```sh
.config/zsh/tools/generate-summary-goal-badge.zsh \
  --output .config/zsh/docs/redesignv2/artifacts/badges/summary-goal.json \
...
- GOAL classifier tests:
  - .config/zsh/tests/performance/classifier/test-goal-*.zsh
- Summary-goal suffix composition:
  - .config/zsh/tests/performance/badges/test-summary-goal-suffix.zsh
