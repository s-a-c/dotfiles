...
echo "Parent process: $$"
echo "ZDOTDIR will be: /Users/s-a-c/.config/zsh"
echo

# Test 1: Direct ZSH launch with command
echo "Test 1: Direct ZSH with immediate command"
ZDOTDIR="${HOME}/.config/zsh" timeout 10 zsh -c 'echo "ZSH COMMAND SUCCESS: $(date)"'
echo "Exit code: $?"
echo
...
ZDOTDIR="${HOME}/.config/zsh" timeout 5 zsh -i &
ZSH_PID=$!
...
echo "---"
ZDOTDIR="${HOME}/.config/zsh" timeout 10 bash -c '
